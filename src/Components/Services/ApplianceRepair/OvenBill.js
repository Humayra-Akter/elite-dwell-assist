      ...
      {userRole === "customer" ? (
              ...
              <div className="absolute top-[607.88px] left-[31.5px] w-[347px] flex flex-col items-start justify-start py-[13px] px-0 box-border text-left text-lg text-black-900">
                <div className="self-stretch flex flex-row items-start justify-start">
                  <div className="flex-1 relative h-[26px]">
                    <div className="absolute top-[-285px] left-[0px] leading-[30px] font-semibold">
                      Total
                    </div>
                    <div className="absolute top-[calc(-1048%_-_13px)] right-[0px] leading-[30px] font-semibold text-right">
                      {total}
                    </div>
                  </div>
                </div>
              </div>
              <div className="absolute top-[336px] left-[384.5px] text-lg leading-[30px] font-semibold text-right">
                tk
              </div>
        ...
        <div>
          ...
          <div className="flex">
            ...
            {/* <div> */}
            <div
              className="absolute top-[calc(105%_-_424.5px)] left-[calc(53%_+_194.5px)] w-[441px] h-[690px] text-center text-base"
              id="items"
            >
              <div className="absolute top-[180.88px] left-[27.5px] w-[376px] h-[137px]">
                <div className="absolute top-[0px] left-[0px] bg-white box-border w-[376px] h-[137px] border-[1px] border-solid border-gray1-200" />
              ...
              <div className="absolute top-[335px] left-[384.5px] text-lg leading-[30px] font-semibold text-right">
                tk
              </div>
              <div className="absolute top-[calc(50%_-_344.88px)] left-[calc(50%_-_154.5px)] text-xl leading-[24px] font-medium text-left">
                Services
              ...
              <div>
                <div className="card w-full bg-transparent border-4 rounded-3xl border-blue-200 text-blue-800">
                  <div className="card-body">
                    ...
                    <p>Expert will arrive at the address given below</p>
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <div className="form-control pt- w-full">
                        <label className="label">
                      ...
                      <div className="pl-20 pt-9">
                        <input
                          className="btn w-2/3 btn-sm border-primary text-white text-xs font-bold bg-primary"
                          value="BOOK"
                          type="submit"
                          disabled
                        />
