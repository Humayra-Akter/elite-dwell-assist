...
const TVBill = () => {
  ...
  const divStyle1 = {
    ...
    marginRight: "35px", // Adjust the right margin as needed
  };
    ...
    <div>
      {userRole === "customer" ? (
        <div>
          ...
          <div className="flex">
            <div className="ml-8" style={divStyle}>
              {/* <div className="flex"> */}
            ...
            <div className="absolute right-20 w-96 text-center text-base">
              ...
              <div className="absolute top-[607.88px] left-[31.5px] w-[347px] flex flex-col items-start justify-start py-[13px] px-0 box-border text-left text-lg text-black-900">
                <div className="self-stretch flex flex-row items-start justify-start">
                  <div className="flex-1 relative h-[26px]">
                    ...
                    <div className="absolute top-[calc(50%_-_13px)] right-[0px] leading-[30px] font-semibold text-right">
                      {total}
                    </div>
                  </div>
                </div>
        ...
        <div>
          <h1
            className="text-3xl pt-2 text-center font-black text-primary  px-7"
            style={{ fontFamily: "arial" }}
          >
            Your Home-Our Expertise
          </h1>
          <div className="bg-white p-2 mt-4 mx-96 rounded-lg shadow-md mb-4">
            <p className="text-lg text-center text-black font-semibold">
              {displaySelectedInfo()}
            </p>
          </div>
          <div className="grid grid-cols-3 pt-14">
            <div className="ml-12" style={divStyle}>
              {/* <div className="flex"> */}
              <div className="time-slot-container pt-10">
                <strong className="text-lg mx-5 font-bold text-center text-primary">
                  Select a Time Slot :
                </strong>
                <select
                ...
                {/* </div> */}
                <div>
                  <h1 className="text-lg font-bold text-primary mx-5 pt-10 text-left">
                    Select a Date
                  </h1>
                  <div className="calendar-container">
                    <DayPicker
            ...
            <div
              className="absolute top-[calc(38%_-_75.5px)] left-[calc(45%_+_350.5px)] w-[441px] h-[690px] text-center text-base"
              id="items"
            >
              <div className="absolute top-[180.88px] left-[27.5px] w-[376px] h-[137px]">
                <div className="absolute top-[0px] left-[0px] bg-white box-border w-[376px] h-[137px] border-[1px] border-solid border-gray1-200" />
