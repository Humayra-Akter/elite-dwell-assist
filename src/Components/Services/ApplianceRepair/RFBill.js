...
const RFBill = () => {
  ...
  const total =
    rfChecking * itemPrice +
    rfServicing * itemPrice +
    rfRepairing * itemPrice ;
  ...
  const handleServiceSelect = () => {
    ...
    if (rfRepairing > 0) {
      updatedServices.push({ name: "Refrigerator Repairing", count: rfRepairing });
    }
